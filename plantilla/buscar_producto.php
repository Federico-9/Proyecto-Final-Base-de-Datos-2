...
if (empty($_POST['nombre']) || empty($_POST['clave'])){
  ...
  if ($result >0) {
    ...
    header('location: http://localhost/plantilla/buscar_producto2.php');
...
<section id="content" >
    ...
    <form method="get" action="buscar_producto.php" class="form_search" >
          <input  type="text" name="busqueda" id="busqueda" placeholder=" Nombre Producto" value="<?php echo $busqueda1; ?>">
      ...
      <div align="center" >
        <table >
          ...
          $sql_contador= mysqli_query($conexion,"SELECT COUNT(*) as cantidad from producto WHERE nombre_producto LIKE '%$busqueda1%'");
          ...
          $sql="SELECT * FROM producto WHERE nombre_producto LIKE '%$busqueda1%' LIMIT $desde,$por_pagina";
