...
if (empty($_POST['nombre']) || empty($_POST['clave']))
{
  ...
  if($result >0){
    ...
    header('location: http://localhost/plantilla/stock1B.php');
...
<section id="content" >
    ...
    <h2 align="center" class="p3">Lista de Productos Tienda 1:</h2>

    <table class="buscador">
      <tr>
        <td>
    <form method="get" action="buscar_producto.php" class="form_search" >
          <input  type="text" name="busqueda" id="busqueda" placeholder=" NombreProducto">
