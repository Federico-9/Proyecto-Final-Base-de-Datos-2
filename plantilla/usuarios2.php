...
<section id="content" class="content-subpages">
  <h2 align="center" class="p3">Lista de Usuarios</h2>

    <table class="buscador">
      <tr>
        <td>
    <form method="get" action="buscar_usuario2.php" class="form_search" >
      ...
      <div align="center" >
        <table >
          ...
          $sql_contador= mysqli_query($conexion, "SELECT COUNT(*) as cantidad from usuario where estatus=1");
          ...
          $sql="SELECT * FROM usuario where estatus=1 LIMIT $desde,$por_pagina ";
          ...
          { 
            ...
            if ($_SESSION['tipo']==1) {
            ?>
            <a href="editar_usuario.php? id=<?php echo $consulta['id_usuario']; ?>" class=link_modificar">Editar</a>
            <a href="eliminar_confirmar.php? id=<?php echo $consulta['id_usuario']; ?>" class="link_eliminar">Eliminar</a>
            <?php
            }
