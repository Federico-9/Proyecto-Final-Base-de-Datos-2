...
if (empty($_POST['nombre']) || empty($_POST['clave']))
{
  ...
  if($result >0){
    ...
    header('location: http://localhost/plantilla/usuarios2.php');
    ...
    <form method="get" action="buscar_usuario.php" class="form_search" >
      ...
      <div align="center" >
        <table >
          ...
          $sql_contador= mysqli_query($conexion, "SELECT COUNT(*) as cantidad from usuario where estatus!=0");
          ...
          $sql="SELECT * FROM usuario LIMIT $desde,$por_pagina";
